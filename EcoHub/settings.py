...
SECRET_KEY = "django-insecure-6232du=xhjoo3+_j#+uc*k_^)!s^6$p=ga7^mq@6qny7b@_i#&"
...
GOOGLE_MAPS_API_KEY = 'AIzaSyA2pTcEM22xZUrzhA2tLwORYnCkVvUOkCo'


# AWS S3 Configuration
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME = 'eco-hub-bucket'
